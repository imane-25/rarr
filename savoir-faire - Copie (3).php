...
<head>
    ...
    <title>Savoir-Faire Artisanal | Beldi Artisanat Marocain</title>
...
<body>
        ...
        <div class="header-container">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="collection1.php">Collections</a></li>
                    <li><a href="savoir-faire.php" class="active">Savoir-Faire</a></li>
    ...
    <!-- Hero Section -->
    <section class="hero" style="background-image: url('ss.jpg'); height: 70vh; min-height: 600px;">
        <div class="hero-content">
            <div class="hero-text">
                <h2>Savoir-Faire Artisanal</h2>
                <p>Découvrez les techniques ancestrales qui font la renommée de l'artisanat marocain à travers les siècles.</p>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="section-header">
            <h2>Nos Techniques d'Exception</h2>
            <p>Chaque pièce Beldi est le fruit d'un savoir-faire transmis de génération en génération, alliant patience, précision et passion.</p>
        </div>
        ...
        <div class="technique-section">
            <div class="technique-header">
                ...
                <div>
                    <h3>Zellige Traditionnel</h3>
                    <p>L'art géométrique de la mosaïque marocaine</p>
                </div>
            </div>
            
            <div class="technique-content">
                <div class="technique-text">
                    <p>Le zellige est une technique de mosaïque ancestrale apparue au Maroc au Xe siècle. Chaque pièce de terre cuite émaillée est taillée à la main selon des formes géométriques précises, puis assemblée pour créer des motifs complexes.</p>
                    <p>Nos maîtres zelligeurs perpétuent cet art avec une exigence de perfection, tout en innovant avec des coloris contemporains et des applications modernes.</p>
                </div>
                <div class="technique-image">
                    <img src="omm.jpg" alt="Fabrication de zellige">
                </div>
            </div>
            ...
            <div class="process-steps">
                <div class="process-step">
                    ...
                    <h4>Préparation de l'argile</h4>
                    <p>L'argile est soigneusement sélectionnée, malaxée et mise en forme en plaques uniformes.</p>
                </div>
                <div class="process-step">
                    <span class="step-number">2</span>
                    <h4>Cuisson et émaillage</h4>
                    <p>Les plaques sont cuites puis recouvertes d'émaux aux pigments naturels avant une seconde cuisson.</p>
                </div>
                <div class="process-step">
                    <span class="step-number">3</span>
                    <h4>Taille des pièces</h4>
                    <p>Avec un marteau spécial, le zelligeur taille chaque pièce selon des angles précis.</p>
                </div>
                <div class="process-step">
                    <span class="step-number">4</span>
                    <h4>Assemblage des motifs</h4>
                    <p>Les pièces sont assemblées à l'envers sur un support temporaire avant fixation définitive.</p>
                </div>
            </div>
        </div>
        ...
        <div class="technique-section">
            <div class="technique-header">
                ...
                <div>
                    ...
                    <p>L'art du tapis noué à la main</p>
                </div>
            </div>
            
            <div class="technique-content">
                <div class="technique-text">
                    <p>Les tapis berbères sont tissés à la main par des artisanes qui perpétuent des techniques millénaires. Chaque motif raconte une histoire et représente l'identité d'une tribu ou d'une région.</p>
                    <p>Nos tisserandes utilisent exclusivement de la laine vierge filée à la main et des colorants naturels (indigo, safran, henné...).</p>
                </div>
                <div class="technique-image">
                    <img src="tiss.jpg" alt="Tissage de tapis berbère">
                </div>
            </div>
        </div>
        ...
        <div class="technique-section">
            <div class="technique-header">
                ...
                <div>
                    <h3>Travail du Cuivre</h3>
                    <p>La transformation du métal en œuvres d'art</p>
                </div>
            </div>
            
            <div class="technique-content">
                <div class="technique-text">
                    <p>Les dinandiers de Marrakech et Fès martèlent le cuivre et le laiton depuis des siècles pour créer des luminaires, plateaux et objets décoratifs.</p>
                    <p>Chaque pièce est travaillée à froid selon des techniques de martelage et de ciselage qui demandent une grande maîtrise et des heures de travail minutieux.</p>
                </div>
                <div class="technique-image">
                    <img src="cuiii.jpg" alt="Travail du cuivre artisanal">
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- Call to Action -->
    <section class="cta" style="background-image: url('artisans-at-work.jpg');">
        <h2>Transmission d'un Héritage</h2>
        <p>En achetant une pièce Beldi, vous participez à la préservation de ces savoir-faire uniques et soutenez directement nos artisans.</p>
        <a href="collecti.php" class="btn">Découvrir les Créations</a>
    </section>
