...
</div><input type="text" id="orderTextField" placeholder="Votre commande..." style="width: 100%; margin-top: 20px;" readonly>
...
function saveOrderToDatabase(orderLines, paymentMethod) {
    ...
    isSubmitting = true;
    const userId = 1;
    const orderData = { user_id: userId, order_lines: orderLines, payment_method: paymentMethod };
    ...
    .then(data => {
        ...
        if (data.success) {
            ...
            showMessageModal("❌ Erreur lors de l'enregistrement de la commande.");
        }
    })
    .catch(error => {
        isSubmitting = false;
...
</body><div id="messageModal" class="modal">
