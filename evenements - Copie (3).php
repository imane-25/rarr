...
<head>
    ...
    <title>Événements | Beldi Artisanat Marocain</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <link href="https://fonts.googleapis.com/css2?family=Playfair+Display:wght@400;700&family=Montserrat:wght@300;400;600&display=swap" rel="stylesheet">
    <style>
        /* CSS commun (identique à home.php) */
        :root {
 ...
 .header-icon:hover {
        ...
        .events-hero {
            background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('event-bg.jpg');
            background-size: cover;
            background-position: center;
            height: 60vh;
            min-height: 500px;
        ...
        .newsletter-section {
            background: linear-gradient(135deg, rgba(204, 119, 34, 0.1) 0%, rgba(212, 175, 55, 0.1) 100%);
            padding: 80px 0;
            margin-top: 100px;
            text-align: center;
        }
...
.modal {
    ...
    position: fixed;
    z-index: 1; /* Place la fenêtre modale au-dessus des autres éléments */
    left: 0;
    top: 0;
    width: 100%;
    height: 100%;
    background-color: rgba(0, 0, 0, 0.4); /* Fond semi-transparent */
    padding-top: 100px; /* Pour centrer la fenêtre modale verticalement */
}
...
<body><script type="text/javascript">
    ...
    (function () {
        emailjs.init('7zbC33g0M8dUwKkr6'); // Remplace par ta clé publique
    })();

    // Fonction pour afficher le formulaire après clic
    document.getElementById('showFormBtn').addEventListener('click', function() {
        // Affiche le formulaire en modifiant le style
        document.getElementById('reservationFormContainer').style.display = 'block';

        // Cache le bouton "Réserver" après le clic
    ...
    document.getElementById('reservationForm').addEventListener('submit', function(event) {
        ...
        // Envoie l'email via EmailJS avec les informations récupérées du formulaire
        emailjs.send('service_56b9pls', 'template_s6cynfa', {
            from_name: name,
            from_email: email,
            message: message
    ...
    <!-- Hero Section -->
    <section class="events-hero" style="background-image: url(jj.jpg);">
        <div class="hero-content">
            <div class="hero-text" style="max-width: 800px; margin: 0 auto;">
                <h2>Nos Événements</h2>
                <p>Découvrez nos rencontres artisanales, expositions et ateliers pour vivre l'artisanat marocain autrement</p>
            </div>
        </div>
    </section>
    ...
    <section class="section">
        <div class="section-header">
            ...
            <p>Participez à nos prochaines rencontres et découvrez l'artisanat marocain en direct</p>
        </div>
    ...
    <div class="event-image" style="position: relative;">
        <img src="event1.jpg" alt="Rencontre avec les artisans">
    ...
    <div class="event-details">
        ...
        <!-- Le bouton pour afficher le formulaire -->
        <button id="showFormBtn" class="event-cta">Réserver</button>
    </div>
</div>
...
<div id="reservationModal" class="modal">
    <div class="modal-content">
        ...
        <form id="reservationForm">
            ...
            <button type="submit" class="event-cta">Envoyer ma réservation</button>
        </form>
    </div>
</div>
            ...
            <div class="event-card">
                <div class="event-image" style="position: relative;">
                    <img src="event2.jpg" alt="Atelier Zellige">
                    <div class="event-date">
                ...
                <div class="event-details">
                    <h3>Atelier Initiation au Zellige</h3>
                    <div class="event-meta">
                        <span><i class="far fa-clock"></i> 10h - 13h</span>
                        <span><i class="fas fa-map-marker-alt"></i> Atelier Beldi, Marrakech</span>
                    </div>
                    <p class="event-excerpt">
            ...
            <div class="event-card">
                <div class="event-image" style="position: relative;">
                    <img src="event3.jpg" alt="Exposition Tapis">
                    <div class="event-date">
                ...
                <div class="event-details">
                    <h3>Exposition "Tapis Berbères du Haut Atlas"</h3>
                    <div class="event-meta">
                        <span><i class="far fa-clock"></i> 9h - 19h</span>
                        <span><i class="fas fa-map-marker-alt"></i> Galerie Beldi, Marrakech</span>
                    </div>
                    <p class="event-excerpt">
            ...
            <div class="events-container">
                ...
                <div class="event-card">
                    <div class="event-image">
                        <img src="sos.jpg" alt="Soirée de lancement">
                    </div>
                    <div class="event-details">
                        <h3>Soirée de Lancement Collection Été</h3>
                        <div class="event-meta">
                            <span><i class="far fa-calendar"></i> 12 Mai 2025</span>
                        </div>
                        <p class="event-excerpt">
                            Une soirée mémorable pour présenter notre nouvelle collection estivale. Plus de 200 invités ont pu découvrir nos nouvelles créations en avant-première.
                        </p>
                    </div>
                </div>
                ...
                <div class="event-card">
                    <div class="event-image">
                        <img src="ate.jpg" alt="Atelier Cuivre">
                    </div>
                    <div class="event-details">
                        <h3>Atelier Travail du Cuivre</h3>
                        <div class="event-meta">
                            <span><i class="far fa-calendar"></i> 18 Avril 2025</span>
                        </div>
                        <p class="event-excerpt">
                            Hassan Benbrahim a initié 15 participants aux techniques de base du martelage du cuivre. Un succès qui sera renouvelé prochainement.
                        </p>
                    </div>
                </div>
                ...
                <div class="event-card">
                    <div class="event-image">
                        <img src="kr.jpg" alt="Exposition Zellige">
                    </div>
                    <div class="event-details">
                        <h3>Exposition "Zellige Contemporain"</h3>
                        <div class="event-meta">
                            <span><i class="far fa-calendar"></i> 10 Mars 2025</span>
                        </div>
                        <p class="event-excerpt">
                            Pendant 3 semaines, notre galerie a accueilli des œuvres exceptionnelles mêlant zellige traditionnel et design contemporain. Plus de 1500 visiteurs.
                        </p>
                    </div>
                </div>
            </div>
